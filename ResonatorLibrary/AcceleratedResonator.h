...
/*!
 a resonator class that contains methods for computing output values using exponential multiplication
 this class has capabilites for setting damping and scale parameters
 */
